...
**Solution:**
- Use fixed, versioned prompt templates stored in `.verification-before-completion/prompts/`
...
- Store calibration results in `.verification-before-completion/calibration.json`
