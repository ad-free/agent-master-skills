...
Load `references/quality-gate-gotchas.md` for the full list, including: judge sensitivity to prompt wording, rubric drift, confidence calibration, FP/FN rates, position bias, context window limits, and latency impact.
